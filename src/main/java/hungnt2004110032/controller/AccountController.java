...
import hungnt2004110032.security.UserDetailsImpl;
...
public class AccountController {
	...
	public String editProfile(Model model, Authentication auth) { 
		UserDetailsImpl user= (UserDetailsImpl) auth.getPrincipal(); //hungnt2004110032.security.UserDetailsImpl 
	...
	public String editProfile(Model model, Authentication auth,
		...
		if(!accountService.existByUsername(account.getUsername())){
			...
			UserDetailsImpl user= (UserDetailsImpl) auth.getPrincipal();// lấy user từ bộ nhớ ra									 //hungnt2004110032.security.UserDetailsImpl 
